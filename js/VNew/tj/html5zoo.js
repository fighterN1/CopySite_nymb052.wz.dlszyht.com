	...
	$.fn.html5zoo = function(G) {
		...
		J.prototype = {
			...
			createStyle: function() {
				$(".html5zoo-space-" + this.id, this.container).html("<img style='width:100%;height:"+this.options.height+"px;max-width:100%;' src='" + this.elemArray[0][ELEM_SRC] + "' />");
				...
				var a = ".html5zoo-wrapper-" + this.id + " {display:block;position:relative;margin:0 auto;width:" + this.options.width + "px;height:auto;}";
				a += ".html5zoo-slider-" + this.id + " {display:block;position:relative;left:0px;top:0px;width:100%;height:" + this.options.height + "px;";
			...
			slideRun: function(a) {
				...
				if (this.isAnimating) {
					...
					$(".html5zoo-img-box-" + this.id, this.container).unbind('transitionFinished').html("<div class='html5zoo-img-" + this.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:100%;height:auto;'><img style='position:absolute;max-width:100%;height:"+this.options.transition+"px;left:0%;top:0%;' src='" + this.elemArray[savedCur][ELEM_SRC] + "' /></div>");
